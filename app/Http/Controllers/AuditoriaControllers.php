...
class AuditoriaControllers extends Controller
{
    ...
    public function consultarAuditoriaGeneral(Request $request)
    {
        try {
            ...
            $this->logController->saveLog(
                'Nombre de Controlador:AuditoriaControllers, Nombre de Funcion: consultarAuditoriaGeneral(Request $request)',
                $e->getMessage()
            );
            return response()->json(['error' => 'Error al consultar auditoría'], 500);
        }
    }
