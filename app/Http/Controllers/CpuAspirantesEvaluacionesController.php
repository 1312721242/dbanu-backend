...
class CpuAspirantesEvaluacionesController extends Controller
{
    public function getEvaluaciones(Request $request)
    {
        ...
        // Auditoría
        $this->auditar('cpu_aspirantes_evaluaciones', 'getEvaluaciones', '', '', 'CONSULTA', "CONSULTA DE EVALUACIONES PARA PERIODO: $periodo, IDENTIFICA: $identifica", $request);
    ...
    public function getEvaluacionesCedula(Request $request)
    {
        ...
        // Auditoría
        $this->auditar('cpu_aspirantes_evaluaciones', 'getEvaluacionesCedula', '', '', 'CONSULTA', "CONSULTA DE EVALUACIONES POR CEDULA", $request);
    ...
    public function updateAsistencia(Request $request)
    {
        ...
        // Auditoría
        $this->auditar('cpu_aspirantes_evaluaciones', 'updateAsistencia', '', $identifica, 'MODIFICACION', "ACTUALIZACION DE ASISTENCIA PARA IDENTIFICA: $identifica", $request);
    ...
    public function getReporteEvaluaciones(Request $request)
    {
        ...
        // Auditoría
        $this->auditar('cpu_aspirantes_evaluaciones', 'getReporteEvaluaciones', '', '', 'CONSULTA', "REPORTE DE EVALUACIONES DESDE: $fechaInicio HASTA: $fechaFin", $request);
