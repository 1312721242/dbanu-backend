    ...
    public function guardarIngresos(Request $request)
    {
        ...
        try {
            ...
            $encabezado = [
                ...
                'ei_tipo_adquisicion'   => $encabezadoReq['tipo_adquisicion'],
                'ei_id_proveedor'       => $encabezadoReq['id_proveedor'] ?: null,
                'ei_fecha_emision'      => $encabezadoReq['fecha_emision'],
                'ei_fecha_vencimiento'  => $encabezadoReq['fecha_vencimiento'],
                'ei_created_at'         => now(),
                'ei_updated_at'         => now(),
                'ei_id_bodega'          => $encabezadoReq['select_bodega'],
                'ei_id_user'            => $request->user()->id,
                'ei_id_estado'          => 8,
                'ei_detalle_producto'   => json_encode($detalleProductos),
            ];
